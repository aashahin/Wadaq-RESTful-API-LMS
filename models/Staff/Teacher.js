...
const teacherSchema = new Schema({
    ...
    teacherId: {
        type: String,
        default: () => {
            return "TE" + this.name.split(' ').join('').toLowerCase() + Math.floor(Math.random() * 1000);
        }
    },
    avatar: {
        type: String,
        default: 'https://pub-ebc3292441104a07b54e254192a1b246.r2.dev/bubble-gum-avatar-icon.png'
    },
    email: {
        type: String,
